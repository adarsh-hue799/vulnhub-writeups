::: page
# Enumeration {#enumeration .title}

\

Found this using **smbclient** :

![](60-1.png)

We tried to smb into **kathy** :

![](60-2.png)

We found this for **kathy** :
...
\# and IPv4 clients. It is not necessary to listen on \*both\* IPv4 and
IPv6
...
\# (Warning! chroot\'ing can be very dangerous. If using chroot, make
sure that
