...
We used **hydra to crack elly\'s password** :

![](55-4.png)

We got **elly\'s password** :

Logged into **elly and searched many files** and found a **passwd file**
:
...
We tried to **bruteforce using hydra** for multiple users on **port 22**
:
